...
public interface ConversationMapper {
     ...
     * @return 会话列表
     */
    List<Conversation> selectByMode(@Param("mode") String mode);
     ...
     * @return 会话列表
     */
    List<Conversation> selectByPlanetGrowthRange(@Param("minGrowth") Integer minGrowth,
     ...
     * 
     * @param id           会话ID
     * @param planetGrowth 新成长值
     * @return 影响的行数
     */
    int updatePlanetGrowth(@Param("id") Integer id, @Param("planetGrowth") Integer planetGrowth);
     ...
     * @return 会话数量
     */
    int countByMode(@Param("mode") String mode);
     ...
     * @return 会话模式分布
     */
    List<Conversation> selectModeDistribution();
